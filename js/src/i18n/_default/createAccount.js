...
export default {
  ...
  newGeth: {
    ...
    noKeys: `There are currently no importable keys available from the Geth keystore, which are not already available on your Affinity instance`
  },
  newImport: {
    file: {
  ...
  recoveryPhrase: {
    ...
    warning: {
      ...
      shortPhrase: `The recovery phrase is less than 11 words.
                This account has not been generated by Affinity and might be insecure.
    ...
    windowsKey: {
      label: `Key was created with Affinity <1.4.5 on Windows`
    }
  },
  title: {
