      ...
      <div className={ styles.welcome }>
        ...
        <p>
          <FormattedMessage
            ...
            defaultMessage='As part of a new installation, the next few steps will guide you through the process of setting up your Affinity instance and your associated accounts. Our aim is to make it as simple as possible and to get you up and running in record-time, so please bear with us. Once completed you will have -'
          />
        </p>
        <div>
          <ul>
            ...
            <li>
              <FormattedMessage
                ...
                defaultMessage='Created your first Affinity account'
              />
            </li>
            <li>
              <FormattedMessage
